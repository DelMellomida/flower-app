...
const App = () => {
  ...
  return (
    <><h1 className="text-center text-3xl font-bold mt-8">{headingText}</h1><p className="text-center text-xl mt-2">For now, here's a flower and a smile for you Ma. Margaret F. :</p><Flower /><Smiley mood={mood} /><div className="button-box mt-4">
